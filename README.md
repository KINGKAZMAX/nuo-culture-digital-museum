...
「贵傩戏 · 傩文化数字博物馆」是一座开在浏览器里的展馆：五面贵州傩戏面具以每面 65,536 点的实时点云陈列于宣纸色数字展厅。观展不隔玻璃：手掌移动即可旋转藏品，挥手切换展品，握拳令傩面爆散为星尘；点击「AR 试戴」，面具即刻附着在镜头中的人脸上，挥手换面、拍照打卡、生成海报分享；也可以让语音向导自动讲解傩的历史与形制。无需安装任何应用，打开网页即可观展。
...
| 移动端 | 手机浏览器 | 自拍试戴 + 打卡海报生成与社交分享，适配 390×844 及以上视口 |
...
- **馆藏画廊**：五面傩面缩略图陈列，点击进馆
- **展厅观展**：宣纸色展厅 + 彩色点云面具 + 顶栏展品铭牌 + 底栏进度刻度
- **AR 试戴**：24,000 抽样点实时附着人脸，额头至下巴全覆盖，One Euro 滤波平滑跟随
- **打卡海报**：视频帧 + 面具层合成，龙藏行书标题 + 朱砂傩印 + 日期，一键分享或保存
...
2. 面具自动附着画面中的人脸（额头—下巴全覆盖，转头平滑跟随；侧脸超过阈值自动淡出避免错位）
...
| 贴脸绑定 | **刚体绑定 + One Euro 滤波** | 额头—下巴高度 × 太阳穴间距双向拟合定尺度，24k 抽样全覆盖点径自适应 |
...
展陈视觉体系：黑金红粒子主视觉、宣纸色展厅 UI、龙藏行书标题、朱砂印章点缀；五面展品铭牌——**鎏金开山 / 玄青判官 / 苍玉灵官 / 琥珀傩公 / 赭霞土地**。全部点云资产、字体、语音、音乐离线自托管，可整体复用于线下展陈。
